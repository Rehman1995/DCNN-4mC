...
def prediction(filename,number_of_sequences,model_weights):
    ...
    c10 = Conv1D(32,7, strides=1, activation='relu', input_shape=(41, 4), padding = 'same')(inputs)
    c1 = BatchNormalization()(c10)
    #c1 = MaxPooling1D(4,strides=2, padding = 'same')(c1)
    #c1 = Dropout(0.1)(c1)
    
    u1 = concatenate([inputs, c1])
    #c2 = Conv1D(32,5, strides=1, activation='relu', padding = 'same')(u1)
    ...
    c2 = MaxPooling1D(4,strides=2)(u1)
    c2 = Dropout(0.40)(c2)
...
model_weights='equisetifolia.h5'
number_of_sequences=6471
